// app/admin/construction-equipment/construction-equipment-filter.tsx
"use client";
...
export const constructionEquipmentSubCategoryOptions = [
  ...
  { label: "Power Tools", value: "tools" },
];

export const constructionEquipmentCityOptions = [
...
const ConstructionEquipmentFilters = () => {
  ...
  const {
    ...
    setCity,
    resetFilters,
  } = useConstructionEquipmentFilterStore();
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                <SelectContent>
                  {constructionEquipmentSubCategoryOptions.map((o) => (
            ...
            <div className="flex flex-col gap-1.5 col-span-2">
              ...
              <Select value={localCity} onValueChange={setLocalCity}>
                ...
                <SelectContent>
                  {constructionEquipmentCityOptions.map((o) => (
                    <SelectItem key={o.value} value={o.value}>
                      {o.label}
                    </SelectItem>
                  ))}
...
export default ConstructionEquipmentFilters;
