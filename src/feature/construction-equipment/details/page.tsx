// app/admin/construction-equipment/edit/[id]/page.tsx
"use client";
...
export default function EditConstructionEquipmentPage({ params }: Props) {
  ...
  if (!listing) {
    return (
      <div className="text-center py-12">
        <p className="text-red-600">Construction equipment listing not found</p>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">
            Edit Construction Equipment Listing
          </h1>
