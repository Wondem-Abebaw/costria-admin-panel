// app/admin/commercial/commercial-filter.tsx
"use client";
...
export const commercialSubCategoryOptions = [
  { label: "Office Space", value: "office-space" },
  { label: "Retail Shop", value: "shop" },
  { label: "Warehouse", value: "warehouse" },
  { label: "Complex (Full Building)", value: "complex" },
  { label: "Coworking Space", value: "coworking" },
  { label: "Restaurant/Café", value: "restaurants" },
  { label: "Storage Unit", value: "storage-units" },
];

export const commercialCityOptions = [
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                <SelectContent>
                  {commercialSubCategoryOptions.map((o) => (
