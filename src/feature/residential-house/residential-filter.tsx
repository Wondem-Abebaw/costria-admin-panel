// app/admin/residential/residential-filter.tsx
"use client";
...
export const residentialSubCategoryOptions = [
...
export const residentialCityOptions = [
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                <SelectContent>
                  {residentialSubCategoryOptions.map((o) => (
