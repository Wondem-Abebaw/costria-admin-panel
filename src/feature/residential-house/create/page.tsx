// app/admin/residential/create/page.tsx
"use client";
...
export default function CreateResidentialPage() {
  ...
  const handleUserSelect = (userId: string, user: User) => {
    ...
    } = require("@/lib/store/residential-form-store");
    const store = useResidentialFormStore.getState();
    store.setFormData({
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">
            Add Residential Property Listing
          </h1>
          <p className="text-gray-600">
            Create a new residential property rental listing for a user
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Select the user who owns this property
              </p>
            </div>
