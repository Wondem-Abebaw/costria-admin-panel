// app/admin/vehicles/create/page.tsx
"use client";
...
export default function CreateVehiclePage() {
  ...
  const handleUserSelect = (userId: string, user: User) => {
    ...
    const { useVehicleFormStore } = require("@/lib/store/vehicle-form-store");
    const store = useVehicleFormStore.getState();
    store.setFormData({
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Add Vehicle Listing</h1>
          <p className="text-gray-600">
            Create a new vehicle rental listing for a user
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Select the user who owns this vehicle
              </p>
            </div>
      ...
      {/* Vehicle Form */}
      {selectedUser && <VehicleListingForm mode="create" />}
